...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 06, 2020 at 02:53 AM
...
CREATE TABLE `dataumum` (
  ...
  `fileupload` int(11) NOT NULL,
  `tglentri` datetime DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- AUTO_INCREMENT for table `fungsiutama`
--
ALTER TABLE `fungsiutama`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT for table `ketersediaanta`
--
ALTER TABLE `ketersediaanta`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `penggunalayanan`
--
ALTER TABLE `penggunalayanan`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT for table `pkkhusus`
--
ALTER TABLE `pkkhusus`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `pkutama`
--
ALTER TABLE `pkutama`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `plpendukung`
--
ALTER TABLE `plpendukung`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `plutama`
--
ALTER TABLE `plutama`
...
--
-- AUTO_INCREMENT for table `sistempengaman`
--
ALTER TABLE `sistempengaman`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `sistemterkait`
--
ALTER TABLE `sistemterkait`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT for table `tenagaahli`
--
ALTER TABLE `tenagaahli`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
ALTER TABLE `dataumum`
  ...
  ADD CONSTRAINT `dataumum_ibfk_18` FOREIGN KEY (`fileupload`) REFERENCES `fileupload` (`id`),
